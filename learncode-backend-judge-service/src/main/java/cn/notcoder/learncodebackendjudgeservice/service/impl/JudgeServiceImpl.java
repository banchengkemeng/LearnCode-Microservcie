package cn.notcoder.learncodebackendjudgeservice.service.impl;

import cn.notcoder.learncodebackendcommon.utils.JudgeUtils;
...
import cn.notcoder.learncodebackendmodel.model.judge.JudgeInfoMessage;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public Future<JudgeInfo> judgeQuestion(JudgeRequest judgeRequest) {
        ...
        try {
            // 开始判题
            questionSubmitFeignClient.saveOrUpdate(
    ...
    private void updateJudgeInfoToDatabase(QuestionSubmit questionSubmit) {
        questionSubmitFeignClient.saveOrUpdate(questionSubmit);
    }
}
